...
\emph{Sayoo} utilise des outils et frameworks performants et récents pour mieux gérer les projets et gagner en termes de coût et de temps.

\paragraph*{Développement Web/Mobile}
Le développement mobile tient une place importante au sein de l'entreprise parce que le marché mobile est en constante progression en offres et en demandes. 
...
\item La supervision est manuelle. En effet, au fur et à mesure que le nombre de clients augmente, l'administrateur doit ajouter les applications au système de supervision. Ce processus devient faible et non évolutif. Par conséquent, le suivi est pénible en termes de ressources et de temps.
...
\item Réduire le coût en termes de temps et d'argent pour \emph{Sayoo}.
