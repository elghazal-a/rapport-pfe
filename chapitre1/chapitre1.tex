...
\emph{Sayoo} se penche aussi sur la gestion des entreprises via Odoo (anciennement Open ERP). Ce service tient une place importante pour la société notamment dans sa personnalisation.
...
\item L'absence d'une architecture robuste qui peut garantir des exigences non fonctionnelles énormes, à savoir la configuration, la haute disponibilité, la sécurité et la scalabilité. Ainsi, Sayoo ne garantie pas un SLA à ses clients.
