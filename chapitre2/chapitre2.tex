...
Lors de cette étude, nous allons se baser sur un travail réalisé par IBM*, où nous allons mettre l'accent sur les la différence des performances entre Docker et KVM. Le benchmark concerne 15 machines virtuelles simultanément en marche sous OpenStack.
