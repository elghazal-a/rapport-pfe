...
\initial{C}e chapitre a pour objectif de présenter la conception du projet. Cette phase est un point de fusion entre l'analyse des besoins et l'étude approfondie de la documentation. Comment un \acrshort{saas} doit être conçu. Enfin, une architecture pour porter les \acrshort{saas} sera présenté.
